$(function() {
	...
	$.extend(Calc.prototype, {
		...
		bind: function() {
			...
			this.$fees.on('click', $.proxy(this.getFees, this));
			this.$interest.on('click', $.proxy(this.getInterest, this));
		...
		calculate: function(event){
			...
			if(this.$slider2.val()<1001){
				var payment = (+this.$slider2.val() * (0.0018*this.$slider.val()))+ +this.$slider2.val()+(this.$slider2.val())*0.15+60;
				console.log(payment);
			...
			{
				var payment = +this.$slider2.val() * ((0.0018*this.$slider.val()))+ +this.$slider2.val()+((this.$slider2.val()-1000)*0.1+1000*0.15)+60;
			console.log(payment);
